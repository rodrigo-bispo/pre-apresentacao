...
namespace Monitoria.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string ReturnUrl)
        {
            ...
            var result = await SignInManager.PasswordSignInAsync(model.Email, model.Senha, model.RememberMe, shouldLockout: false);
            switch (result)
            {
        ...
        public async Task<ActionResult> ExternalLoginCallback(string returnUrl)
        {
            ...
            switch (result)
            {
                ...
                case SignInStatus.LockedOut:
                    return View("Lockout");
                case SignInStatus.RequiresVerification:
                    return RedirectToAction("SendCode", new { Email = returnUrl, RememberMe = false });
                case SignInStatus.Failure:
                default:
